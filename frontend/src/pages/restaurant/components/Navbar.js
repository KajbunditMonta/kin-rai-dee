    ...
    return (
        <div className='fixed bottom-0 z-50 h-24 w-full bg-white border-t flex justify-around items-center px-2 shadow-[0_-2px_10px_rgba(0,0,0,0.1)]'>
            ...
            <button onClick={() => navigate('/HomeRestaurant')} className='flex flex-col items-center group'>
                <img className='w-8 h-8 group-active:scale-90 transition-transform' src={homeImg} alt='Home' />
                <p className='text-[10px] mt-1'>หน้าหลัก</p>
            </button>

            <button onClick={() => navigate('/AcceptedOrders')} className='flex flex-col items-center group'>
                <img className='w-8 h-8 group-active:scale-90 transition-transform' src={acceptImg} alt='Accept' />
            ...
            <button onClick={() => navigate('/RejectOrder')} className='flex flex-col items-center group'>
                <img className='w-8 h-8 group-active:scale-90 transition-transform' src={cancelImg} alt='Reject' />
                <p className='text-[10px] mt-1'>ปฏิเสธแล้ว</p>
            </button>

            <button onClick={() => navigate('/Profile')} className='flex flex-col items-center group'>
                <img className='w-8 h-8 group-active:scale-90 transition-transform' src={profileImg} alt='Profile' />
